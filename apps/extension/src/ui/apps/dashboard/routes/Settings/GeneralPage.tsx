      ...
      <div className="mt-16 flex flex-col gap-4">
        {hasRuntimeReloadFn ? (
          <Setting
            ...
            title={t("Reload Dubai Customs Wallet")}
            subtitle={t("Close and restart Dubai Customs Wallet, this can help to resolve error states")}
          >
        ...
        <Setting
          ...
          subtitle={t("Allow Dubai Customs Wallet to send you notifications about transactions in progress")}
        >
          <Toggle
        ...
        <Setting
          ...
          subtitle={t("Hide tokens with a balance below AED 1")}
        >
